...
export interface Type<E = any> {
	...
	/**
	 * Returns true if and only if all members passed as arguments conform to
	 * this Type.
	 *
	 * @param input Any number of variables to check for conformity to this
	 * Type.
	 * @return true if and only if all members passed as arguments conform to
	 * this Type.
	 */
	checkConformityOfAll(...input: any[]): boolean;
	
	/**
	 * Returns true if and only if the input value exhaustively conforms to
	 * this Type.
	 *
	 * Note that the exact definition of "exhaustively conformity" differs
	 * between Types.
	 *
	...
	/**
	 * Returns true if and only if all members passed as arguments exhaustively
	 * conform to this Type.
	 *
	 * Note that the exact definition of "exhaustively conformity" differs
	 * between Types.
	 *
	 * @param input Any number of variables to exhaustively check for conformity
	 * to this Type.
	 * @return true if and only if all members passed as arguments exhaustively
	 * conform to this Type.
	 */
	exhaustivelyCheckConformityOfAll(...input: any[]): boolean;
	
	/**
	 * Either returns the given input if it correctly conforms to this
	 * {@link Type}, or throws a TypeError.
	 *
	 * @param input The input to sanitize.
	 * @return The given input if it correctly conforms to this Type.
	 * @throws A TypeError if the provided input does not correctly conform to
	 * this Type.
	 */
